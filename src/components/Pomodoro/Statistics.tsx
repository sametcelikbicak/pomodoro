        ...
        <Card className="w-full max-w-md shadow">
            ...
            <CardContent>
                <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="text-right">{secondsToHMS(stats.totalFocusSeconds)}</div>

                    <div className="text-muted-foreground">Total break</div>
                    <div className="text-right">{secondsToHMS(stats.totalBreakSeconds)}</div>
                </div>

                <div className="mt-4 text-right">
                    <button className="text-xs text-destructive underline cursor-pointer" onClick={resetStats}>Reset stats</button>
                </div>
            </CardContent>
        </Card>
    );
